...
export default function Welcome() {
    ...
    return (
        <div className="flex items-center gap-4 bg-white dark:bg-gray-800 p-6 rounded-xl shadow-md border border-gray-200 dark:border-gray-700 mb-8">
            ...
            <div>
                ...
                <p className="text-gray-600 dark:text-gray-300">
                    Welcome to WAJIBU Contract Monitoring System,
                    Stay ahead with Wajibu CMS real-time analytics.
                </p>
            </div>
        </div>
    );
