...
import { CheckCircle, X, LogIn, Info } from "lucide-react";
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4">
            <div className="w-full max-w-md rounded-lg bg-white p-6 shadow-xl dark:bg-gray-800">
                ...
                <div className="mb-6 w-full rounded-lg bg-gray-100 p-4 dark:bg-gray-700">
                    <strong className="text-center text-lg text-gray-800 dark:text-white block">
                        {email}
                    </strong>
                </div>
                ...
                <div className="flex w-full flex-col gap-3">
                    <button
                        ...
                        className="flex w-full items-center justify-center gap-2 rounded-lg bg-brand-500 px-4 py-3 font-semibold text-white transition-all hover:bg-brand-600"
                    >
